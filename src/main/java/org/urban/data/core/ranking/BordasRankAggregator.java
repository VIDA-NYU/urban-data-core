 ...
 */
public class BordasRankAggregator {
    
    private final IdentifiableCounterSet _elements = new IdentifiableCounterSet();
    ...
    public <T extends IdentifiableObject> void add(
        ...
        this.add(elements.toList(), comparator);
    }
    ...
    public List<Integer> getRanking() {
        ...
        for (IdentifiableCount el : _elements.toSortedList(false)) {
            result.add(el.id());
        }
