...
public class MaxDropFinder <T extends IdentifiableDouble> extends CandidateSetFinder<T> {
    ...
    public int getPruneIndex(List<T> elements, int start) {
        ...
        if (first < _emptySignatureThreshold) {
            return 0;
        }
